...
export {default as headband2} from './images/bony2.jpeg';
...
export {default as shirtimg} from './images/collarsshirt.jpg';
export {default as pantsimg} from './images/pants.jpg';
export {default as collarshirt} from './images/beadmen.jpg';
export {default as headbon} from './images/bonney.png';
export {default as native2} from './images/native2atta.jpg';
export {default as shirt2} from './images/shirts-DIKAMLxg.jpg';
export {default as pants2} from './images/pants2.jpg';
export {default as vintage} from './images/beadedbag.jpg';
