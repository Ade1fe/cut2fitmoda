...
import { FaFacebook, FaHeart, FaInstagram, FaStar, FaTruck, FaWhatsapp } from 'react-icons/fa';
...
const HomepageComp = () => {
  ...
  return (
    <Box pt='50px' className='texts'>
      ...
      {/* Testimonials */}
      <Box my={['10rem']} px='4' maxWidth='1340px' mx='auto' textAlign='center'>
        <Text textAlign='center' fontSize={['sm', 'md']} color='orange.400'>Testimonials</Text>
        <Text fontSize={['md','lg','xl']} fontWeight='600'>Why Choose Our Fashion Collection</Text>
        <Box display="grid" gridTemplateColumns={['1fr', '1fr', '1fr 1fr', '1fr 1fr 1fr']} gap='10' mt='2rem'>
          <Box p='10' shadow='base' h='300px' display='flex' flexDir='column' alignItems='center' justifyContent='center' gap='6' borderRadius='20px'> 
            ...
            <Text mb='0px'>Stylish Designs</Text>
            <Text mb='0px'>I've never felt more confident in my outfits since I started shopping here. The designs are always so trendy and unique!</Text>
          ...
          <Box p='10' shadow='2xl' h='300px' display='flex' flexDir='column' alignItems='center' justifyContent='center' gap='6' borderRadius='20px'> 
            <FaTruck size={40} color='blue' />
            <Text mb='0px'>Fast Shipping</Text>
            <Text mb='0px'>I'm amazed by how quickly my orders arrive. It's like Christmas every time I receive a package from your store!</Text>
            <Text mb='0px' fontWeight='bold'>- Alex Johnson</Text>
          </Box>
          <Box p='10' shadow='base' h='300px' display='flex' flexDir='column' alignItems='center' justifyContent='center' gap='6' borderRadius='20px'> 
            <FaHeart size={40} color='red' />
            <Text mb='0px'>Quality Fabrics</Text>
            <Text mb='0px'>The fabric of your clothing is so comfortable and durable. I've washed my favorite dress countless times, and it still looks brand new!</Text>
      ...
      {/* Newsletter Signup */}
      <Box maxW="1340px" mx="auto" p={[4,4,4,4,2]} display={['block','block', "flex"]} alignItems='center'>
        <Box flex="1">
          <Image src={emails} alt="Newsletter Image" maxW="100%" />
        </Box>
        <Box flex="1" maxW="600px" ml={4}>
          <Stack spacing={6}>
            <Heading as="h1" fontSize="2xl" >Stay Updated</Heading>
            ...
            <form onSubmit={handleSubmit}>
              <Box display="flex">
                ...
                <Button type="submit" bg='purple.300' px='4' py='2' colorScheme="blue" size="md">Subscribe</Button>
              </Box>
            </form>
          </Stack>
        </Box>
